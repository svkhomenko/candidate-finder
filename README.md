<head>
    <div align="center">
        <h1 align="center">Candidate Finder</h1>
    </div>
</head>
...
<h3>An application that should ensure the improvement of recruiting efficiency by automating the task of matching the knowledge and skills of candidates with the requirements of the target profile of the position.</h3>
